...
export const IOSPermissionsContent: React.FC<IOSPermissionsContentProps> = ({
  onOpenSettings, onRequestPermissions
}) => {
  return (
    <ScrollView style={permissionStyles.container}>
            ...
            <View style={permissionStyles.infoCard}>
              ...
              <Text style={permissionStyles.infoText}>iOS - Bluetooth Permissions</Text>
            </View>
            ...
            <View style={permissionStyles.permissionCard}>
              ...
              <View style={permissionStyles.statusRow}>
                ...
                <Text style={permissionStyles.statusText}>Automatic (No Manual Request)</Text>
              </View>
            </View>
            ...
            <View style={permissionStyles.warningCard}>
              ...
              <Text style={permissionStyles.warningText}>
                ...
                Go to the "SDK Status" tab and tap "Start SDK" to trigger the Bluetooth permission dialog.
              </Text>
            </View>
      ...
      <TouchableOpacity
                  ...
                  >
                    ...
                    <Text style={permissionStyles.primaryButtonText}>How to Enable Permissions</Text>
                  </TouchableOpacity>
